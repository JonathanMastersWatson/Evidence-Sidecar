...
**K6 — Fail-Open**
On failure, systems must fail open, reveal governing rules, and default to human choice. Fail-closed behavior concentrates authority at the gate and creates denial-of-service attack surfaces.
